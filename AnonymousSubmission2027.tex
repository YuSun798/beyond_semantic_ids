...
candidate paths with finite-width beam search. CQG-Single produces one 
...
reported in Appendix~\ref{app:loss-objectives}.
...
coverage; the full table is reported with the crossover diagnostics in
Appendix~\ref{app:crossover-values}.
...
\subsection{Crossover and Output-Coverage Diagnostics}
...
\paragraph{Matched Catalog Coverage.}
\begin{table}[H]
\centering
\small
...
\bottomrule
\end{tabular}
\caption{Matched Catalog Coverage: empirical union-of-Top-$K$ catalog coverage
for seed 42. ML-1M and
